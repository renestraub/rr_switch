...
static const char* sos_GetProcessName( SOS_ProcessId id )
{
  ...
  case Process_Watchdog:      return "Watchdog";
  case Process_ExtReset:      return "ExtReset";
  case Process_Supervisor:    return "Supervisor";
  case Process_LED:           return "LED";
  default:                    DBG_ASSERT(False); return "<unknown>";
  }
}
